...
const FEATURES = [
  { icon: Layers, title: 'Sprite to Game in <30s', desc: 'Upload asset, pick lobby template, deploy live HTML5 in one click.' },
  ...
  { icon: Sparkles, title: 'Cultural Asset Pipeline', desc: 'Vision Smith (Gemini 3 Pro), Sprite Registry, CORS-safe CDN injection.' },
  { icon: Crown, title: 'Lobby Composer', desc: 'Mix bosses, backgrounds, jackpot tiers — each lobby compiles to its own URL.' },
];
    ...
    <div className="min-h-screen bg-[#050008] text-white overflow-x-hidden" style={{ fontFamily: "'Rajdhani','Orbitron',monospace" }} data-testid="showcase-page">
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-6 pt-20 pb-12 md:pt-32 md:pb-20 text-center">
        ...
        <h1 className="font-black uppercase mb-6 leading-[0.95]" style={heroH1Style}>
          <span className="block text-white" style={heroLine1Style}>One Stack.</span>
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-6 mb-16 md:mb-24" data-testid="showcase-pillars">
        <div className="text-center mb-10">
          <div className="text-[10px] uppercase tracking-[6px] text-zinc-500 mb-3">The Ecosystem</div>
          <h2 className="text-3xl md:text-5xl font-black uppercase" style={sectionTitleStyle}>Five Pillars · One Brain</h2>
        </div>
