...
const THEMES = {
  // U0 — Parent Universe / Control Plane
  factory:     { hex: CANON_PALETTE.cyan,     text: 'text-[#00C8FF]', border: 'border-[#00C8FF]', bg: 'bg-[#00C8FF]', bgAlpha: 'bg-[#00C8FF]/10',  label: 'SLA113',       sub: 'U0 · Parent Universe · Control Plane' },
  // U1 — Creative Intelligence
  foundry:     { hex: CANON_PALETTE.gold,     text: 'text-[#D4AF37]', border: 'border-[#D4AF37]', bg: 'bg-[#D4AF37]', bgAlpha: 'bg-[#D4AF37]/10',  label: 'LYRICA3',      sub: 'U1 · Creative Intelligence · Soulfire Studio' },
  // U2 — Cultural OS
  cultura:     { hex: CANON_PALETTE.roseGold, text: 'text-[#B76E79]', border: 'border-[#B76E79]', bg: 'bg-[#B76E79]', bgAlpha: 'bg-[#B76E79]/10',  label: 'CULTURA',      sub: 'U2 · Cultural OS · Vibe Forge' },
  // U3 — AAA OS Factory
  southern:    { hex: CANON_PALETTE.emerald,  text: 'text-[#10b981]', border: 'border-[#10b981]', bg: 'bg-[#10b981]', bgAlpha: 'bg-[#10b981]/10',  label: 'SOUTHERN',     sub: 'U3 · AAA OS Factory · Arcade + Experiences' },
  // U4 — Enterprise SaaS
  empire:      { hex: CANON_PALETTE.indigo,   text: 'text-[#6366f1]', border: 'border-[#6366f1]', bg: 'bg-[#6366f1]', bgAlpha: 'bg-[#6366f1]/10',  label: 'EMPIRE 1',     sub: 'U4 · Enterprise SaaS · Revenue Matrix' },
  // U5 — Operator OS
  omni:        { hex: CANON_PALETTE.violet,   text: 'text-[#7c3aed]', border: 'border-[#7c3aed]', bg: 'bg-[#7c3aed]', bgAlpha: 'bg-[#7c3aed]/10',  label: 'OMNI OS',      sub: 'U5 · Operator OS · Persona Runtime' },
  // U6 — El Arquitecto AI (product under U2 Cultura)
  arquitecto:  { hex: CANON_PALETTE.chrome,   text: 'text-[#E5E4E2]', border: 'border-[#E5E4E2]', bg: 'bg-[#E5E4E2]', bgAlpha: 'bg-[#E5E4E2]/10',  label: 'ARQUITECTO',   sub: 'U6 · El Arquitecto AI · Cultural Product (U2)' },
  // U10 — Engine Vault
  vault:       { hex: CANON_PALETTE.deepRed,  text: 'text-[#8B0000]', border: 'border-[#8B0000]', bg: 'bg-[#8B0000]', bgAlpha: 'bg-[#8B0000]/10',  label: 'BLACK BOX',    sub: 'U10 · Engine Vault · Registry' },
};

const ALL_NAV_ITEMS = [
  // U0 — SLA113 Parent Universe / Control Plane
  ...
  { id: 'SYSTEM CORE',        icon: ShieldCheck,       partition: 'factory' },
  { id: 'NIGHT QUEUE',        icon: Layers,            partition: 'factory' },
  // U1 — Lyrica3 Creative Intelligence
  { id: 'SOULFIRE STUDIO',    icon: Music,             partition: 'foundry' },
  { id: 'AUDIO FORGE',        icon: Mic,               partition: 'foundry' },
  { id: 'VISION SMITH',       icon: ImageIcon,         partition: 'foundry' },
  { id: 'OS BUILDER',         icon: Layout,            partition: 'foundry' },
  // U2 — Cultura Vibe Forge Cultural OS
  { id: 'VIBE FORGE',         icon: Paintbrush,        partition: 'cultura' },
  { id: 'DIALECT MATRIX',     icon: Code,              partition: 'cultura' },
  { id: 'COMPLIANCE',         icon: FileCheck,         partition: 'cultura' },
  // U3 — Southern AAA OS Factory
  { id: 'WHITE LABEL MINT',   icon: Hammer,            partition: 'southern' },
  { id: 'FISH ARENA',         icon: Crosshair,         partition: 'southern' },
  { id: 'SLOT SYMBOLS',       icon: Palette,           partition: 'southern' },
  { id: 'SPRITE REGISTRY',    icon: Scissors,          partition: 'southern' },
  { id: 'BUILD PIPELINE',     icon: Rocket,            partition: 'southern' },
  // U4 — Empire One Enterprise SaaS
  ...
  // U5 — Omni Agent Operator OS
  { id: 'OMNI PERSONAS',      icon: Ghost,             partition: 'omni' },
  { id: 'MATRIX PARAMS',      icon: SlidersHorizontal, partition: 'omni' },
  { id: 'TRIAGE ENGINE',      icon: Zap,               partition: 'omni' },
  // U6 — El Arquitecto AI (Cultural product under U2)
  { id: 'ARQUITECTO STUDIO',  icon: Cpu,               partition: 'arquitecto' },
  { id: 'CULTURAL FILTER',    icon: Shield,            partition: 'arquitecto' },
  { id: 'ARQUITECTO PRD',     icon: FileCheck,         partition: 'arquitecto' },
  // U10 — Black Box Registry Engine Vault
  { id: 'ARTTECH NEXUS',      icon: Grid3X3,           partition: 'vault' },
  { id: 'ENGINE REGISTRY',    icon: Database,          partition: 'vault' },
  { id: 'IDENTITY FIREWALL',  icon: Lock,              partition: 'vault' },
];
    ...
    <>
      ...
      <div className="sla113-scope flex h-screen w-full bg-[#050505] text-zinc-300 font-mono text-sm overflow-hidden select-none" data-testid="sla113-page">
        ...
        <aside className={`w-72 border-r bg-[#050505] flex flex-col shadow-2xl z-20 shrink-0 transition-colors duration-500 ${currentTheme.border}/30`} data-testid="sla113-sidebar">
          ...
          <button onClick={() => navigate('/sla113')} className={`m-4 p-3 border border-zinc-800 text-zinc-500 text-[9px] uppercase tracking-widest hover:text-zinc-300 hover:border-zinc-600 transition-all`} data-testid="back-to-core">
            BACK TO CORE
          </button>
        </aside>
        ...
        <div className="flex-1 flex flex-col relative overflow-hidden bg-[radial-gradient(circle_at_50%_0%,_rgba(255,255,255,0.01)_0%,_transparent_70%)] z-10">
          ...
          <main className="flex-1 overflow-y-auto p-8 custom-scrollbar relative flex flex-col">
            ...
            {partition === 'southern' && activeTab === 'WHITE LABEL MINT' && (
            ...
            {/* FACTORY: FISH ARENA */}
            {partition === 'southern' && activeTab === 'FISH ARENA' && (
            ...
            {/* EMPIRE: SLOT SYMBOLS */}
            {partition === 'southern' && activeTab === 'SLOT SYMBOLS' && (
              <SlotSymbolsPanel />
            )}

            {/* EMPIRE: SPRITE REGISTRY */}
            {partition === 'southern' && activeTab === 'SPRITE REGISTRY' && (
              <SpriteRegistryPanel />
            )}
            ...
            {partition === 'southern' && activeTab === 'BUILD PIPELINE' && (
            ...
            {/* VAULT: COMPLIANCE */}
            {partition === 'cultura' && activeTab === 'COMPLIANCE' && (
            ...
            {/* VAULT: MATRIX PARAMS */}
            {partition === 'omni' && activeTab === 'MATRIX PARAMS' && (
              <MatrixParamsPanel matrixParams={matrixParams} />
            )}

            {/* VAULT: SYSTEM CORE */}
            {partition === 'factory' && activeTab === 'SYSTEM CORE' && (
            ...
            {/* VAULT: NIGHT QUEUE */}
            {partition === 'factory' && activeTab === 'NIGHT QUEUE' && (
            ...
            {/* ── U6 ARQUITECTO: STUDIO ── */}
            {partition === 'arquitecto' && activeTab === 'ARQUITECTO STUDIO' && (
              <div className="animate-in fade-in max-w-7xl mx-auto w-full space-y-6" data-testid="arquitecto-studio-panel">
                <div className="glass-panel border-[#E5E4E2]/20 p-8 text-center space-y-4">
                  <Cpu size={32} className="text-[#E5E4E2] mx-auto" />
                  <h3 className="text-[#E5E4E2] text-sm font-black uppercase tracking-[4px]">El Arquitecto AI</h3>
                  <p className="text-zinc-500 text-[11px] uppercase tracking-widest">U6 · Cultural AI Product · PRD-driven build · Frontend / Backend / Cultural Filter</p>
                  <span className="inline-block mt-2 px-4 py-1.5 border border-[#E5E4E2]/30 text-[#E5E4E2]/60 text-[9px] uppercase tracking-widest">Build In Progress</span>
                </div>
              </div>
            )}

            {/* ── U6 ARQUITECTO: CULTURAL FILTER ── */}
            {partition === 'arquitecto' && activeTab === 'CULTURAL FILTER' && (
              <div className="animate-in fade-in max-w-7xl mx-auto w-full space-y-6" data-testid="cultural-filter-panel">
                <div className="glass-panel border-[#E5E4E2]/20 p-8 text-center space-y-4">
                  <Shield size={32} className="text-[#E5E4E2] mx-auto" />
                  <h3 className="text-[#E5E4E2] text-sm font-black uppercase tracking-[4px]">Cultural Filter</h3>
                  <p className="text-zinc-500 text-[11px] uppercase tracking-widest">U6 · Authenticity enforcement, guardrails, ethics policies, identity profiles — powered by U2 Cultura</p>
                  <span className="inline-block mt-2 px-4 py-1.5 border border-[#E5E4E2]/30 text-[#E5E4E2]/60 text-[9px] uppercase tracking-widest">Engine Online — Interface Coming</span>
                </div>
              </div>
            )}

            {/* ── U6 ARQUITECTO: PRD ── */}
            {partition === 'arquitecto' && activeTab === 'ARQUITECTO PRD' && (
              <div className="animate-in fade-in max-w-7xl mx-auto w-full space-y-6" data-testid="arquitecto-prd-panel">
                <div className="glass-panel border-[#E5E4E2]/20 p-8 text-center space-y-4">
                  <FileCheck size={32} className="text-[#E5E4E2] mx-auto" />
                  <h3 className="text-[#E5E4E2] text-sm font-black uppercase tracking-[4px]">Arquitecto PRD</h3>
                  <p className="text-zinc-500 text-[11px] uppercase tracking-widest">U6 · Product requirements, testing protocol, artifact registry, build checklist</p>
                  <span className="inline-block mt-2 px-4 py-1.5 border border-[#E5E4E2]/30 text-[#E5E4E2]/60 text-[9px] uppercase tracking-widest">Document Store — Interface Coming</span>
                </div>
              </div>
            )}

            {/* ── U1 LYRICA3: SOULFIRE STUDIO ── */}
            {partition === 'foundry' && activeTab === 'SOULFIRE STUDIO' && (
              <div className="animate-in fade-in max-w-7xl mx-auto w-full space-y-6" data-testid="soulfire-studio-panel">
                <div className="glass-panel border-[#D4AF37]/20 p-8 text-center space-y-4">
                  <Music size={32} className="text-[#D4AF37] mx-auto" />
                  <h3 className="text-[#D4AF37] text-sm font-black uppercase tracking-[4px]">Soulfire Studio</h3>
                  <p className="text-zinc-500 text-[11px] uppercase tracking-widest">U1 · Lyrica3 Creative Intelligence — Ghostwriter · MMA · PFA · DNA Tagger · S2 Engine</p>
                  <a href="/lyrica" className="inline-block mt-2 px-8 py-3 border border-[#D4AF37] text-[#D4AF37] text-[10px] font-bold uppercase tracking-[3px] hover:bg-[#D4AF37] hover:text-black transition-all">
                    Open Lyrica3 Studio →
                  </a>
                </div>
              </div>
            ...
            {/* ── U2 CULTURA: VIBE FORGE ── */}
            {partition === 'cultura' && activeTab === 'VIBE FORGE' && (
              <div className="animate-in fade-in max-w-7xl mx-auto w-full space-y-6" data-testid="vibe-forge-panel">
                <div className="glass-panel border-[#B76E79]/20 p-8 text-center space-y-4">
                  <Paintbrush size={32} className="text-[#B76E79] mx-auto" />
                  <h3 className="text-[#B76E79] text-sm font-black uppercase tracking-[4px]">Vibe Forge</h3>
                  <p className="text-zinc-500 text-[11px] uppercase tracking-widest">U2 · Cultural OS · Dialect engine, slang matrix, authenticity filters, heritage logic</p>
                  <span className="inline-block mt-2 px-4 py-1.5 border border-[#B76E79]/40 text-[#B76E79]/60 text-[9px] uppercase tracking-widest">Engine Online — Interface Coming</span>
                </div>
              </div>
            )}

            {/* ── U2 CULTURA: DIALECT MATRIX ── */}
            {partition === 'cultura' && activeTab === 'DIALECT MATRIX' && (
              <div className="animate-in fade-in max-w-7xl mx-auto w-full space-y-6" data-testid="dialect-matrix-panel">
                <div className="glass-panel border-[#B76E79]/20 p-8 text-center space-y-4">
                  <Code size={32} className="text-[#B76E79] mx-auto" />
                  <h3 className="text-[#B76E79] text-sm font-black uppercase tracking-[4px]">Dialect Matrix</h3>
                  <p className="text-zinc-500 text-[11px] uppercase tracking-widest">U2 · Emotional dialects, slang rules, vibe signatures, cultural memory — CCNA Corpus</p>
                  <span className="inline-block mt-2 px-4 py-1.5 border border-[#B76E79]/40 text-[#B76E79]/60 text-[9px] uppercase tracking-widest">Engine Online — Interface Coming</span>
                </div>
              </div>
            )}

            {/* ── U5 OMNI: OMNI PERSONAS ── */}
            {partition === 'omni' && activeTab === 'OMNI PERSONAS' && (
              <div className="animate-in fade-in max-w-7xl mx-auto w-full space-y-6" data-testid="omni-personas-panel">
                <div className="glass-panel border-[#7c3aed]/20 p-8 text-center space-y-4">
                  <Ghost size={32} className="text-[#7c3aed] mx-auto" />
                  <h3 className="text-[#7c3aed] text-sm font-black uppercase tracking-[4px]">Omni Personas</h3>
                  <p className="text-zinc-500 text-[11px] uppercase tracking-widest">U5 · Persona runtime, state machine, guardrails, sales triage — Omni Agent OS</p>
                  <span className="inline-block mt-2 px-4 py-1.5 border border-[#7c3aed]/40 text-[#7c3aed]/60 text-[9px] uppercase tracking-widest">Engine Online — Interface Coming</span>
                </div>
              </div>
            )}

            {/* ── U5 OMNI: TRIAGE ENGINE ── */}
            {partition === 'omni' && activeTab === 'TRIAGE ENGINE' && (
              <div className="animate-in fade-in max-w-7xl mx-auto w-full space-y-6" data-testid="triage-engine-panel">
                <div className="glass-panel border-[#7c3aed]/20 p-8 text-center space-y-4">
                  <Zap size={32} className="text-[#7c3aed] mx-auto" />
                  <h3 className="text-[#7c3aed] text-sm font-black uppercase tracking-[4px]">Triage Engine</h3>
                  <p className="text-zinc-500 text-[11px] uppercase tracking-widest">U5 · Execution control, evaluator rules, persona routing, reporting layer</p>
                  <span className="inline-block mt-2 px-4 py-1.5 border border-[#7c3aed]/40 text-[#7c3aed]/60 text-[9px] uppercase tracking-widest">Engine Online — Interface Coming</span>
                </div>
              </div>
            )}

            {/* ── U10 BLACK BOX: ENGINE REGISTRY ── */}
            {partition === 'vault' && activeTab === 'ENGINE REGISTRY' && (
              <div className="animate-in fade-in max-w-7xl mx-auto w-full space-y-6" data-testid="engine-registry-panel">
                <div className="glass-panel border-[#8B0000]/20 p-8 text-center space-y-4">
                  <Database size={32} className="text-[#8B0000] mx-auto" />
                  <h3 className="text-[#8B0000] text-sm font-black uppercase tracking-[4px]">Engine Registry</h3>
                  <p className="text-zinc-500 text-[11px] uppercase tracking-widest">U10 · Black Box Registry — Lyrica, Southern, Cultura, Omni engine versioning + controlled runtime access</p>
                  <span className="inline-block mt-2 px-4 py-1.5 border border-[#8B0000]/40 text-[#8B0000]/60 text-[9px] uppercase tracking-widest">Vault Sealed — Clearance Required</span>
                </div>
              </div>
            )}

            {/* ── U10 BLACK BOX: IDENTITY FIREWALL ── */}
            {partition === 'vault' && activeTab === 'IDENTITY FIREWALL' && (
              <div className="animate-in fade-in max-w-7xl mx-auto w-full space-y-6" data-testid="identity-firewall-panel">
                <div className="glass-panel border-[#8B0000]/20 p-8 text-center space-y-4">
                  <Lock size={32} className="text-[#8B0000] mx-auto" />
                  <h3 className="text-[#8B0000] text-sm font-black uppercase tracking-[4px]">Identity Firewall</h3>
                  <p className="text-zinc-500 text-[11px] uppercase tracking-widest">U10 · ADR-0005 — routing policy, domain governance, universe boundary enforcement</p>
                  <span className="inline-block mt-2 px-4 py-1.5 border border-[#8B0000]/40 text-[#8B0000]/60 text-[9px] uppercase tracking-widest">Vault Sealed — Clearance Required</span>
                </div>
              </div>
            )}
