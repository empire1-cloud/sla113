...
## 🧩 Standalone SLA113 Export / Build

This repository also includes a standalone export workflow for SLA113. Use the root-level automation helper to export and optionally build a self-contained SLA113 project.

```bash
# Export the standalone SLA113 repo into sla113_export/
bash build_repos.sh sla113-standalone-export

# Export and build the standalone SLA113 repo
bash build_repos.sh sla113-standalone-export-and-build
```

The helper will:
1. export `sla113_standalone/` into `sla113_export/`
2. validate the exported repo structure
