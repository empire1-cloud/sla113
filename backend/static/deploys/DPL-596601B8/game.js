...
const GAME_CONFIG = {
  ...
  "sprites": {
    "wolf_xolotl_pack": {
      "sprite_url": "/api/sla113/sprites/static/wolf_xolotl_pack.png",
      "frame_width": 205,
      "frame_height": 240,
      "columns": 1,
      "rows": 1,
    ...
    "g_wolf": {
      "sprite_url": "/api/sla113/sprites/static/g_wolf.png",
      "frame_width": 1024,
      "frame_height": 1536,
      "columns": 1,
      "rows": 1,
    ...
    "jaguar_warrior": {
      "sprite_url": "/api/sla113/sprites/static/jaguar_warrior.png",
      "frame_width": 312,
      "frame_height": 166,
      "columns": 1,
      "rows": 1,
    ...
    "quetzalcoatl_fireborn": {
      "sprite_url": "/api/sla113/sprites/static/quetzalcoatl_fireborn.png",
      "frame_width": 512,
      "frame_height": 512,
      "columns": 1,
      "rows": 1,
    ...
    "ocelotl_voidmane": {
      "sprite_url": "/api/sla113/sprites/static/ocelotl_voidmane.png",
      "frame_width": 128,
      "frame_height": 128,
      "columns": 2,
      "rows": 2,
    ...
    "aztec_wolf_male": {
      "sprite_url": "/api/sla113/sprites/static/aztec_wolf_male.png",
      "frame_width": 1024,
      "frame_height": 1024,
      "columns": 1,
      "rows": 1,
    ...
    "jaguar_warrior_elite": {
      "sprite_url": "/api/sla113/sprites/static/jaguar_warrior_elite.png",
      "frame_width": 204,
      "frame_height": 261,
      "columns": 1,
      "rows": 1,
    ...
    "jaguar_warrior_champion": {
      "sprite_url": "/api/sla113/sprites/static/jaguar_warrior_champion.png",
      "frame_width": 277,
      "frame_height": 216,
      "columns": 1,
      "rows": 1,
    ...
    "wolf_xolotls_arena": {
      "sprite_url": "/api/sla113/sprites/static/wolf_xolotls_arena.png",
      "frame_width": 800,
      "frame_height": 450,
      "columns": 1,
      "rows": 1,
    ...
    "three_worlds_pyramid": {
      "sprite_url": "/api/sla113/sprites/static/three_worlds_pyramid.png",
      "frame_width": 1024,
      "frame_height": 1024,
      "columns": 1,
      "rows": 1,
  ...
  "loader_url": "/api/sla113/sprites/static/loader.png",
  "background_url": "/api/sla113/sprites/static/wolf_xolotls_arena.png",
  "lobby": {
    "name": "Shadow Pack",
...
(async () => {
  ...
  app.ticker.add(()=>{
    ...
    fishes.forEach(f=>{
      ...
      else if(f.pat==='boss'){if(f.x>W()*0.7)f.vx=-1.6;else if(f.x<W()*0.3)f.vx=1.6;f.x+=f.vx*dt;f.y=H()/2+Math.sin(t)*H()*0.25;}
